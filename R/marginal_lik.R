...
#' @description  Calculate the marginal likelihood from a logfile generated by \code{\link{jive_mcmc}} with thermodynamic integration (Lartillot and Philippe, 2006) or stepping stone (Xie et al., 2011).
...
#' mcmc_jive(my.jive, log.file="my.jive_MCMC_TI.log", ncat=10, sampling.freq=10, print.freq=100, ngen=5000, burnin=0) 
#'  
