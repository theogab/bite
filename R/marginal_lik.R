...
#' @description  Calculate the marginal likelihood from a logfile generated by \code{\link{mcmc_jive}} with thermodynamic integration (Lartillot and Philippe, 2006) or stepping stone (Xie et al., 2011).
...
#' mcmc_jive(my.jive, log.file="my.jive_MCMC_TI.log", ncat=10, sampling.freq=10,
